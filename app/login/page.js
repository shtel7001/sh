...
export default function Login(){
  ...
  async function submit(e){
    ...
    const clean=code.replace(/\D/g,'').slice(0,10); setCode(clean);
    if(clean.length!==10){setState('bad');setMsg('10자리 인증번호를 입력해 주세요.');return;}
